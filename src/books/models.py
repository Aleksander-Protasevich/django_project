...
class Book (models.Model):
    ...
    serie = models.ForeignKey(Series, on_delete=models.CASCADE, verbose_name ='Cерия', related_name = 'serie')
    ...
    publishing = models.ForeignKey(Publishing, on_delete=models.CASCADE, verbose_name ='Издательство', related_name = 'publishing')
    stock = models.PositiveIntegerField(verbose_name = 'В наличии, шт')
    available = models.BooleanField(verbose_name = 'Доступно для заказа', default=True, choices=BOOL_CHOICES)
